...
public class TRMenuAdapter extends RecyclerView.Adapter<TRMenuAdapter.TRMViewHolder> {
    ...
    public void onBindViewHolder(TRMViewHolder holder, int position) {
        ...
        if (menuItem.getText() != null && menuItem.getText().equals("#创建临时组#")){
            holder.text.setTextColor(Color.parseColor("#FFFD0101"));
        }else {
            holder.text.setTextColor(Color.parseColor("#FF0C0C0C"));
        }
