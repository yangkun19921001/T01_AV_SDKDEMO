...
import com.lingyi.autiovideo.test.adapter.MeetingAdapter;
...
public class MeetingListActivity extends AppCompatActivity {
    ...
    @BindView(R.id.pro)
    ProgressBar pro;
    private MeetingAdapter mMettingAdapter;
    ...
    private void initView() {
        ...
        mMettingAdapter = new MeetingAdapter(this, null);
    ...
    private void initListener() {
        tvAlarmmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MeetingListActivity.this, CreateGroupActivity.class);
