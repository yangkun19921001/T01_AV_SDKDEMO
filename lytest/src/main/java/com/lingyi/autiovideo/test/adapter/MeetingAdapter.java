...
public class MeetingAdapter extends BaseQuickAdapter<MeetingSessionEntity, BaseViewHolder> {
    private int voiceCall = 0;
    private int videoCall = 1;


    public MeetingAdapter(MeetingListActivity mettingListActivity, ArrayList<MeetingSessionEntity> data) {
